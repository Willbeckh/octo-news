...
class TestArticle(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_article = Article( "the-verge", "The Verge","Jay Peters", "Block and Blockstream are partnering with Tesla",
    ...
    def test_init(self):
        ...
        """
        self.assertEqual(self.new_article.id, "the-verge")
        self.assertEqual(self.new_article.name, "The Verge")
